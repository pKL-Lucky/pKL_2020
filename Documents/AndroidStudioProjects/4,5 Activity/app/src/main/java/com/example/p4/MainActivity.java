...
import com.example.p4.bean.UserInfo;
import com.example.p4.database.UserDBHelper;
import com.example.p4.util.DateUtil;
import com.example.p4.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"南开大学滨海学院", "教师用户", "18990106裴凯露"};
